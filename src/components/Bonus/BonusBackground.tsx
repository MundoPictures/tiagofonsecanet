...
export const BonusBackground = () => {
  return (
    <>
      ...
      {/* Glowing orbs */}
      <motion.div
        className="fixed top-[30%] left-[20%] w-[300px] h-[300px] rounded-full bg-gradient-to-br from-emerald-700/10 to-emerald-400/5 blur-[100px] z-0"
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.3, 0.5, 0.3],
        }}
      ...
      <motion.div
        className="fixed bottom-[20%] right-[10%] w-[250px] h-[250px] rounded-full bg-gradient-to-tr from-blue-700/10 to-emerald-300/5 blur-[120px] z-0"
        animate={{
          scale: [1.1, 0.9, 1.1],
          opacity: [0.2, 0.4, 0.2],
        }}
