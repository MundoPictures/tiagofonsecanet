...
export const MentoryForm = ({ onSubmit }: MentoryFormProps) => {
  const {
    register,
    handleSubmit,
    control,
  ...
  return (
    <div className="max-w-3xl mx-auto my-12 bg-gray-800/30 p-6 sm:p-8 lg:p-10 backdrop-blur-sm rounded-2xl border border-emerald-500/10 shadow-xl relative z-10">
      ...
      >
        ...
        <div className="form-group">
          <label className="block text-white font-medium mb-2">
            Você está disposto investir até 10Mil, para você aprender com o
            Tiago Fonseca a Triplicar suas vendas?{" "}
            <span className="text-red-500">*</span>
          </label>
          <div className="space-y-2">
            <motion.div className="flex items-center">
        ...
        <div className="mt-8 relative">
          ...
          >
            <span className="mr-1">QUERO FAZER PARTE DA MENTORIA LEGACY</span>
            <span>
