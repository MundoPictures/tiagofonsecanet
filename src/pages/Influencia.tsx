    ...
    <div className="bg-[#0F0A1F] text-white min-h-screen overflow-hidden relative">
      ...
      <section className="relative z-10 text-center px-4 py-12 md:py-20 max-w-6xl mx-auto">
        <img
          src={logoInfluencia}
          alt="Logo Influência"
          className="w-1/2 mx-auto mb-12 relative z-20"
        />
        ...
        <p className="text-gray-300 max-w-2xl mx-auto mb-8 text-lg">
          Transforme sua presença digital com o método da Mentoria Influência.
          Aprenda a construir sua marca e aumentar seu faturamento.
        </p>
        <div className="mb-12">
          <button className="animate-pulse-slow bg-gradient-to-r from-[#FF6B00] to-[#FF9E00] text-white px-8 py-4 rounded-full hover:from-[#FF9E00] hover:to-[#FF6B00] transition-all duration-300 font-bold text-lg shadow-lg transform hover:scale-105 cursor-pointer">
      ...
      <div className="relative z-10 bg-gradient-to-r from-[#3B2A8C] to-[#5A3BAA] py-8 px-4 md:px-8 shadow-xl">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-xl md:text-2xl font-bold mb-6 text-white">
            São 3 dias intensos de aprendizado e mais de 30h de conteúdo para
            você se tornar uma autoridade digital de sucesso.
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            <div className="bg-[#0F0A1F] bg-opacity-70 p-6 rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300">
              <div className="text-[#FF9E00] text-xl font-bold mb-2">
                Dia 10 de Março
              </div>
            ...
            <div className="bg-[#0F0A1F] bg-opacity-70 p-6 rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300">
              ...
              <p className="text-white">
                Edificio Canopus Av. Tambore, 267 - Tamboré - Barueri - SP,
                06460-000 6 Andar - Torre Norte
              </p>
            </div>
          </div>
      ...
      <section className="relative z-10 px-4 py-16 md:py-24 max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <span className="inline-block px-4 py-1 bg-[#3B2A8C] text-[#FF9E00] rounded-full text-sm font-medium mb-4">
            CONTEÚDO EXCLUSIVO
          </span>
          ...
          <p className="text-gray-300 max-w-2xl mx-auto">
            Conteúdos práticos e estratégicos para transformar sua presença
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <div
              key={index}
              className="bg-[#1A1333] p-6 rounded-lg flex items-center shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:translate-y-[-5px]"
            >
      ...
      <section className="relative z-10 px-4 py-16 md:py-24 max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-2/3 md:pl-12">
            <div className="inline-block px-4 py-1 bg-[#3B2A8C] text-[#FF9E00] rounded-full text-sm font-medium mb-4">
              SEU MENTOR
            </div>
            ...
            <div className="space-y-4 text-gray-300">
              <p className="flex items-start">
                ...
                <span>
                  Tiago Fonseca é o maior especialista em viralização de
                  conteúdo do Brasil, onde seus conteúdos já alcançaram milhões
              ...
              <p className="flex items-start">
                <span className="text-[#FF9E00] mr-2">•</span>
                <span>
                  Escritor do Best Seller "Cresça, apareça e enriqueça."
                </span>
              </p>
              <p className="flex items-start">
                <span className="text-[#FF9E00] mr-2">•</span>
                <span>
                  CEO da Mundo Pictures e criador do maior canal de
                  empreendedorismo da América Latina com mais de 2 milhões de
                  inscritos.
                </span>
              </p>
              <p className="flex items-start">
                <span className="text-[#FF9E00] mr-2">•</span>
                <span>
                  Atualmente possui mais de 4 Milhões de seguidores em suas
                  redes sociais.
                </span>
              </p>
            </div>
            <p className="mt-6 text-gray-300 border-l-4 border-[#FF9E00] pl-4 italic">
              "Sua missão é realizar sonhos, impactando milhares de Pessoas e
              negócios no Brasil e mundo, utilizando a transformação digital."
            </p>

            <img
              src={assinaturaTiago}
              alt="Assinatura Tiago"
              className="lg:w-1/5 w-1/3 mt-2"
            />
          </div>
        </div>
      </section>
      ...
      <section className="relative z-10 px-4 py-16 md:py-24 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div
              key={index}
              className="bg-[#1A1333] p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:translate-y-[-5px]"
            >
        ...
        <div className="space-y-4">
          <div className="bg-[#1A1333] p-6 rounded-lg shadow-lg">
            ...
            <p className="text-gray-300">
              Não, o evento é para todos os níveis. Desde iniciantes até
              profissionais que já atuam no mercado digital.
            </p>
          </div>
          <div className="bg-[#1A1333] p-6 rounded-lg shadow-lg">
            <h3 className="text-lg font-medium text-white mb-2">
              O que devo levar para o evento?
            </h3>
            <p className="text-gray-300">
              Recomendamos que traga um notebook para anotações e atividades
              práticas, além de disposição para aprender.
            </p>
          </div>
          <div className="bg-[#1A1333] p-6 rounded-lg shadow-lg">
            <h3 className="text-lg font-medium text-white mb-2">
            ...
            <p className="text-gray-300">
              Sim, todos os participantes receberão um certificado digital após
        ...
        <div className="bg-gradient-to-r from-[#3B2A8C] to-[#5A3BAA] p-10 rounded-2xl shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
              Não perca a oportunidade de aprender com o maior especialista em
              viralização de conteúdo do Brasil. Vagas limitadas!
            </p>
            <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-6">
              <div className="text-center bg-[#0F0A1F] bg-opacity-50 p-4 rounded-lg">
                <div className="text-[#FF9E00] text-xl font-bold">
                  10-12 de Março, 2025
                </div>
